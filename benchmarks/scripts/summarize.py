...
summary['scope']={'selection':'60 fixed-accession convenience genes; not random/genome representative','records':len(records),'unique_genes':len(lookup),'primer_blast':'not_run','wet_lab':'not_run','invalid_returned_pairs':len(invalid),'record_sha256':hashlib.sha256((ROOT/'data/records.json').read_bytes()).hexdigest()}
